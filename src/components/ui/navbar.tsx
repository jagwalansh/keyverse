...
export function Navbar({ staticLayout = false }: NavbarProps) {
  ...
  return (
    <>
      <div
        className="sticky top-0 z-50 mx-auto mb-8 flex flex-col items-center gap-2"
        style={{ width: navWidth }}
      >
        <div
          className="liquid-glass-navbar flex h-[52px] w-full items-center overflow-hidden"
